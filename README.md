...
- **Bank campaign optimization:** predictor-by-predictor decision-time auditing,
  four-model training-only selection, nested calibration choice, paired bootstrap
  uncertainty, information-set sensitivity, and resource-constrained targeting. The
  conservative planning model is separated from richer operational and invalid
  post-contact specifications.
